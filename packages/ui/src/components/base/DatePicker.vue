...
import { CalendarIcon, XIcon } from '@macros/assets'
import chevronLeftIcon from '@macros/assets/icons/chevron-left.svg?raw'
import chevronRightIcon from '@macros/assets/icons/chevron-right.svg?raw'
