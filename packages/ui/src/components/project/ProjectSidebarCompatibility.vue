...
import { FormattedTag, projectCompatibilityMessages, TagItem } from '@macros/ui'
import type { GameVersionTag, PlatformTag } from '@macros/utils'
import { getVersionsToDisplay } from '@macros/utils'
