...
import type { ContentItem, ContentOwner } from '@macros/ui'
...
export async function install_curseforge_file(
	instanceId: string,
	downloadUrl: string,
	fileName: string,
	projectType?: string,
): Promise<string> {
	return await invoke('plugin:instance|instance_install_curseforge_file', {
		instanceId,
		downloadUrl,
		fileName,
		projectType,
