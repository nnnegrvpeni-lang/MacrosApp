...
import { CheckIcon, RadioButtonIcon } from '@macros/assets'
import { Accordion, defineMessages, useVIntl } from '@macros/ui'
...
const messages = defineMessages({
	...
	loginMinecraft: {
		id: 'onboarding-checklist.login-offline',
		defaultMessage: 'Sign in to Offline account',
	},
	loginModrinth: {
		id: 'onboarding-checklist.login-modrinth',
		defaultMessage: 'Sign in to Macros',
	},
})
