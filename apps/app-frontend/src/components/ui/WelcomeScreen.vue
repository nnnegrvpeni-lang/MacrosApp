...
import { ImportIcon, PlusIcon } from '@macros/assets'
import { Button, defineMessages, IntlFormatted, useVIntl } from '@macros/ui'
import { inject, onMounted, onUnmounted, ref } from 'vue'

import macrosLogo from '../../assets/macros_logo.png'
		...
		<div class="relative flex grow items-center justify-center">
			<div class="relative isolate flex flex-col items-center gap-6">
				...
				<div class="size-[6.25rem]">
					<img :src="macrosLogo" alt="" class="pointer-events-none size-full object-contain" />
				</div>
