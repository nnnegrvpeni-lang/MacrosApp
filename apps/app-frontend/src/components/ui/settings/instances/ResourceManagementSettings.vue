<script setup>
import { BoxIcon, FolderOpenIcon, FolderSearchIcon, TrashIcon } from '@macros/assets'
import {
	Button,
	defineMessages,
	IconButton,
...
const messages = defineMessages({
	...
	appDirectoryDescription: {
		...
		defaultMessage:
			'Where Macros App stores instances and other files. Changes take effect after restarting the app.',
	},
	selectAppDirectory: {
	...
	appCacheDescription: {
		...
		defaultMessage:
			'Clear cached data and download it again from MacrosApp. The app may load more slowly until the cache is rebuilt.',
	},
