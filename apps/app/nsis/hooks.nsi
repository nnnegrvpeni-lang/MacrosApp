...
!macro NSIS_HOOK_POSTINSTALL
    ...
    WriteRegStr HKCU "Software\Classes\modrinth\DefaultIcon" "" "$INSTDIR\${MAINBINARYNAME}.exe,1"
    WriteRegStr HKCU "Software\Classes\modrinth\shell" "" "open"
    WriteRegStr HKCU "Software\Classes\modrinth\shell\open\command" "" '"$INSTDIR\${MAINBINARYNAME}.exe" "%1"'

    WriteRegStr HKCU "Software\Classes\macros" "" "URL:Macros Protocol"
    WriteRegStr HKCU "Software\Classes\macros" "URL Protocol" ""
    WriteRegStr HKCU "Software\Classes\macros\DefaultIcon" "" "$INSTDIR\${MAINBINARYNAME}.exe,1"
    WriteRegStr HKCU "Software\Classes\macros\shell" "" "open"
    WriteRegStr HKCU "Software\Classes\macros\shell\open\command" "" '"$INSTDIR\${MAINBINARYNAME}.exe" "%1"'
