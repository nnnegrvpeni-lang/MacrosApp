...
- Отображение скинов и плащей из скиносистемы Ely.by во вкладке «Скины» лаунчера.
- Отображение 2D/3D головы скина в меню профилей и сайдбаре лаунчера.
- ⚠️ **Примечание:** Прямой запуск игры с выбранным профилем Ely.by временно в процессе доработки (для запуска игры пока используйте оффлайн-профиль с вашим ником).
